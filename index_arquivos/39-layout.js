...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});var wpAjaxUrl='http://combatenterico.tmp.k8.com.br/wp-admin/admin-ajax.php';var flBuilderUrl='http://combatenterico.tmp.k8.com.br/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://combatenterico.tmp.k8.com.br/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://combatenterico.tmp.k8.com.br/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if(e.which==13){var currentForm=$(e.currentTarget).closest('.fl-subscribe-form');currentForm.find('a.fl-button').trigger('click');}}}})(jQuery);(function($){$(function(){new FLBuilderSubscribeForm({id:'61156dafc5228',successAction:'redirect',successUrl:'#',});});})(jQuery);